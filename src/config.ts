...
export const testimonialsConfig: TestimonialsConfig = {
  ...
  testimonials: [
    ...
    {
      quote: "После первой встречи стало легче дышать. Я наконец поняла, откуда берётся это ощущение тупика — и главное, что с этим делать. Очень благодарна за честность и тепло.",
      author: "София В.",
      role: "Клиент",
      company: "",
      image: "",
