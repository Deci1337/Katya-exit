...
export function AnimatedButton({
  ...
  const baseStyles = cn(
    ...
    {
      'bg-psych-green text-white hover:bg-psych-green-dark': variant === 'primary',
      'bg-white text-exvia-black border border-exvia-border hover:border-psych-green': variant === 'secondary',
